...
# 2 "<built-in>" 2
# 1 "bsw/static/Spi.c" 2
# 19 "bsw/static/Spi.c"
# 1 "bsw/static/Spi.h" 1
# 35 "bsw/static/Spi.h"
# 1 "bsw/static/../cfg/Spi_Cfg.h" 1
# 35 "bsw/static/Spi.h" 2
...
Spi_ConfigType *Spi_ThisConfiguration = ((void *)0) ;
...
# 50 "bsw/static/Spi.c"
    {
        ...
        SSPCON |= 0x0F & Config_Ptr->Spi_Mode;
        (SSPCON|=(1<<5));
        SSPCON2 = 0;
        SSPADD = (10000000/(4*Config_Ptr->Spi_Baudrate))-1;
        SSPSTAT = 0;
